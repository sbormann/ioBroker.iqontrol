/* ----------------------------------------------------------------------------- 
  ...
  Version 2.0.9 ##### MODIFIED BY S. BORMANN ##### Modified Lines are marked with ----- START MODIFIED BY S. BORMANN ----- and ----- END MODIFIED BY S. BORMANN -----
...
//-----START MODIFIED BY S. BORMANN -----
		if(!apo.tmp._onMouseWheelScroll_timeout){
			apo.tmp._onMouseWheelScroll_iDelta = 0;
			apo.tmp._onMouseWheelScroll_timeout = setTimeout(function(){
				if(apo.tmp._onMouseWheelScroll_iDelta) apo._scrollToPosition("mouseWheel", (apo.tmp.iOffset - (apo.tmp._onMouseWheelScroll_iDelta)), true, "#ap-component-" + apo.tmp.iScrollingComp + " .ap-component-data");
				apo.tmp._onMouseWheelScroll_iDelta = 0;
				apo.tmp._onMouseWheelScroll_timeout = false;
			}, 135);
			apo._scrollToPosition("mouseWheel", (apo.tmp.iOffset - (iDelta)), true, "#ap-component-" + apo.tmp.iScrollingComp + " .ap-component-data");
		} else {
			apo.tmp._onMouseWheelScroll_iDelta += iDelta;
		}
//-----END MODIFIED BY S. BORMANN -----
