...
var uiElementOptions = {
	icon: [
		...
		{option: "iconActive", type: "conditionArray", role: "array", roleOptions: "+array;-const;-deviceOption;-deviceSetting;-deviceCondition", description: "Optional. You can set conditions under which the element is active, that is, whether it is visible or not."},
	...
	text: [
		...
		{option: "textActive", type: "conditionArray", role: "array", roleOptions: "+array;-const;-deviceOption;-deviceSetting;-deviceCondition", description: "Optional. You can set conditions under which the element is active, that is, whether it is visible or not."},
	...
	clickAction: [
		{option: "stackCycles", type: "checkbox", description: "If true, multiple elements on the stack are displayed one after the other, otherwise simultaneously. Default: false."},
		{option: "clickActionActive", type: "conditionArray", role: "array", roleOptions: "+array;-const;-deviceOption;-deviceSetting;-deviceCondition", description: "Optional. You can set conditions under which the element is active, that is, whether it is visible or not."},
		...
		{option: "contextMenuToggleActive", type: "conditionArray", role: "array", roleOptions: "+array;-const;-deviceOption;-deviceSetting;-deviceCondition", description: "Optional. You can set conditions under which the element is active, that is, whether it is visible or not."},
		...
		{option: "contextMenuDialogActive", type: "conditionArray", role: "array", roleOptions: "+array;-const;-deviceOption;-deviceSetting;-deviceCondition", description: "Optional. You can set conditions under which the element is active, that is, whether it is visible or not."},
		...
		{option: "contextMenuEnlargeActive", type: "conditionArray", role: "array", roleOptions: "+array;-const;-deviceOption;-deviceSetting;-deviceCondition", description: "Optional. You can set conditions under which the element is active, that is, whether it is visible or not."},
		...
		{option: "contextMenuOpenLinkToOtherViewActive", type: "conditionArray", role: "array", roleOptions: "+array;-const;-deviceOption;-deviceSetting;-deviceCondition", description: "Optional. You can set conditions under which the element is active, that is, whether it is visible or not."},
		...
		{option: "contextMenuOpenURLExternalActive", type: "conditionArray", role: "array", roleOptions: "+array;-const;-deviceOption;-deviceSetting;-deviceCondition", description: "Optional. You can set conditions under which the element is active, that is, whether it is visible or not."},
	...
	enlargeButton: [
		...
		{option: "enlargeButtonActive", type: "conditionArray", role: "array", roleOptions: "+array;-const;-deviceOption;-deviceSetting;-deviceCondition", description: "Optional. You can set conditions under which the element is active, that is, whether it is visible or not."},
...
async function load(settings, onChange) {
	...
	var dialogDeviceEditTileSettingsElementOptionsConditionArrayTable;
				...
				switch(option.type){
					case "conditionArray":
						...
						var $editButton = $(`<a data-index="${option.optionIndex}" data-command="edit" class="values-buttons btn-floating btn-small waves-effect waves-light"><i class="material-icons">edit</i></a>`).on('click', function(){
							...
							dialogDeviceEditTileSettingsElementOptionsConditionArrayTable = tryParseJSON($(`#tableDialogDeviceEditTileSettingsElementOptions_${_optionIndex}`).val() || '') || [];
							initDialog('dialogDeviceEditTileSettingsElementOptionsConditionArray', function(){ //save dialog
								var _optionIndex = $('#dialogDeviceEditTileSettingsElementOptionsConditionArrayIndex').val();
								$(`#tableDialogDeviceEditTileSettingsElementOptions_${_optionIndex}`).val(JSON.stringify(dialogDeviceEditTileSettingsElementOptionsConditionArrayTable));
							}, function(){ //init dialog function
								$('#dialogDeviceEditTileSettingsElementOptionsConditionArrayName').html(option.option);
								$('#dialogDeviceEditTileSettingsElementOptionsConditionArrayIndex').val(_optionIndex);
								values2table('tableDialogDeviceEditTileSettingsElementOptionsConditionArray', dialogDeviceEditTileSettingsElementOptionsConditionArrayTable, onChange, ontableDialogDeviceEditTileSettingsElementOptionsConditionArrayReady);
							});
						});
	...
	function ontableDialogDeviceEditTileSettingsElementOptionsConditionArrayReady(){
		var $div = $('#tableDialogDeviceEditTileSettingsElementOptionsConditionArray');
		var $table = $div.find('.table-values');
		var $lines = $table.find('.table-lines');
		...
		$lines.find('select[data-name="activeStateRole"], select[data-name="activeConditionRole"], select[data-name="activeConditionTresholdRole"]').each(function(){
			$(this).on('change', function(){
				...
				var target = `#tableDialogDeviceEditTileSettingsElementOptionsConditionArray tbody input[data-index="${index}"][data-name="${targetName}"]`;
				var $target = $(target);
				switch(val){
					case "deviceCondition": 
		...
		//Make table sortable
		$("#tableDialogDeviceEditTileSettingsElementOptionsConditionArray tbody").sortable({
			helper: fixHelper,
			start: function(event, ui){
				console.log("Drag started...");
			},
			stop: function( event, ui ) {
				console.log("Drag ended, start resorting...");
				$("#tableDialogDeviceEditTileSettingsElementOptionsConditionArray tbody").sortable('disable');
				var sequence = [];
				$('#tableDialogDeviceEditTileSettingsElementOptionsConditionArray').find('.table-values').find('.table-lines').find('tr').each(function(){
					sequence.push($(this).data('index'));
				});
				var tableResorted = [];
				for(var i = 0; i < sequence.length; i++){
					tableResorted.push(dialogDeviceEditTileSettingsElementOptionsConditionArrayTable[sequence[i]]);
				}
				dialogDeviceEditTileSettingsElementOptionsConditionArrayTable = tableResorted;
				onChange();
				values2table('tableDialogDeviceEditTileSettingsElementOptionsConditionArray', dialogDeviceEditTileSettingsElementOptionsConditionArrayTable, onChange, ontableDialogDeviceEditTileSettingsElementOptionsConditionArrayReady);
				$("#tableDialogDeviceEditTileSettingsElementOptionsConditionArray tbody").sortable('enable');
				console.log("resorted.");
			},
			axis: "y",
			handle: "a[data-command='drag_handle']"
